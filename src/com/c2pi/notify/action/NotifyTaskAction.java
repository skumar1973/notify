...
public class NotifyTaskAction extends ActionSupport implements SessionAware,
	...
	public String execute() throws Exception {
		...
		String res = "";
		res = ntm.addNotifyTask((Integer) sessionMap.get("empID"), empTaskIDArray,
				periodDate, (String) sessionMap.get("loginID"));
		
		res=ntm.sendNotifyEmail(empTaskIDArray, (Integer) sessionMap.get("empID"));
	...
	public void validate() {
		...
		if (empTaskIDArray.length == 0) {
			...
			empTaskNameList = ntm.getEmpTaskList((String) sessionMap.get("loginID"));
